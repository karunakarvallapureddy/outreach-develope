							...
							<div class="col-sm-12">
								<div class="page-header">
									...
									<ul class="breadcrumb">
										...
										<li><a href="<?php echo site_url('admin/admin/presentation_reporting');?>">Presentation & Reporting</a></li>
									...
									<div class="col-md-9">
										<div class="box border dark gray">
											...
											<span id="error" class='error'></span>
												<form class="form-horizontal" method="post" name="presentation" id="presentation" action="<?php echo site_url('admin/presentation_reporting_edit/'.base64_encode($presentation_reporting_data[0]['id']));?>" role="form" enctype="multipart/form-data">
