							...
							<div class="col-sm-12">
								<div class="page-header">
									...
									<ul class="breadcrumb">
										...
										<li><a href="<?php echo site_url('admin/admin/workshop_material');?>">Workshop Material</a></li>
										<li>Add New Workshop Material</li>
									</ul>
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">Add New Workshop Material</h3>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-9">
										<div class="box border dark gray">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i>Add New Workshop Material </h4>
											</div>
											<div class="box-body big">
											<span id="error" class='error'></span>
												<form class="form-horizontal" method="post" name="addworkshopmaterial" id="addworkshopmarerial" action="<?php echo site_url('admin/workshop_material_add');?>" role="form" enctype="multipart/form-data">
