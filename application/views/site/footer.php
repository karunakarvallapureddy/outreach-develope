<!-- BEGIN FOOTER -->
		<footer id="colophon" class="assests/site-footer " role="contentinfo">
		<div class="footer">
			<div class="container">
				<div class="row">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12 foote-gap">
                     ...
                     <span class="pull-right">Developed by <a href="http://www.possibilliontech.com/" target="_blank">Possibillion</a>  </span>
					</div>
					<!-- end col left -->
