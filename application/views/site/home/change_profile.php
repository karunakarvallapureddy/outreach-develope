...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			...
			<?php } ?>
			<form action="<?php echo base_url(); ?>site/profile" onsubmit="return pwdvalidation();"  class="form-horizontal" method="post"enctype="multipart/form-data" name="student_login">
				...
				<div class="row" id="printerdiv">
					...
					<div style="float:left; width:100%" class="print-table">
						<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
							...
							<tr>
								<td width="30%" align="right" class="student-title">Profile Photo
								<br/>
								<img src="<?php echo base_url(); ?>assests/images/profile.png" alt="" class="fixed-img" /><!--<img src="..." alt="..." class="img-circle">--></td>
								...
								<td width="70%" align="left"  class="student-details">Upload your photo
...
if($ses_data['user_type']==2){
						...
						<td width="70%" align="left"  class="student-details"><?php echo $ses_data['workshop']; ?><
						/td>
						</tr>
						<tr>
						<td width="30%" align="right" class="student-title">Participants to cover</td>
						<td width="70%" align="left"  class="student-details"><?php echo $ses_data['participants']; ?><
						/td>
						</tr>
						<tr>
						<td width="30%" align="right" class="student-title">Experiments to conduct</td>
						<td width="70%" align="left"  class="student-details"><?php echo $ses_data['experiments']; ?><
						/td>
						</tr>
						</table>
